namespace eval ::optrace {
  variable script "C:/work/cam_hdmi/cam_hdmi.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/work/cam_hdmi/cam_hdmi.cache/wt [current_project]
  set_property parent.project_path C:/work/cam_hdmi/cam_hdmi.xpr [current_project]
  set_property ip_repo_paths c:/Users/yvan2/Downloads/vivado-library-master [current_project]
  update_ip_catalog
  set_property ip_output_repo C:/work/cam_hdmi/cam_hdmi.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/work/cam_hdmi/cam_hdmi.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files C:/work/cam_hdmi/cam_hdmi.srcs/sources_1/bd/design_1/design_1.bd
