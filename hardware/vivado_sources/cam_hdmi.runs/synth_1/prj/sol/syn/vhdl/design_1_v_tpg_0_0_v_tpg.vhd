...
architecture behav of design_1_v_tpg_0_0_v_tpg is 
    ...
    "design_1_v_tpg_0_0_v_tpg,hls_ip_2024_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=13.468000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.199600,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=9,HLS_SYN_DSP=0,HLS_SYN_FF=7493,HLS_SYN_LUT=8957,HLS_VERSION=2024_1}";
