...
set C_modelArgMapList {[ 
	{ "Name" : "boxHCoord_loc_0", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "conv2_i_i_i129", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ conv2_i_i_i129 sc_in sc_lv 8 signal 4 } 
	...
	{ zext_ln1889 sc_in sc_lv 9 signal 18 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv2_i_i_i129", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "conv2_i_i_i129", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	conv2_i_i_i129 { ap_none {  { conv2_i_i_i129 in_data 0 8 } } }
